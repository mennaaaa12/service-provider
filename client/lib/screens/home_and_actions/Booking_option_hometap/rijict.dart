import 'dart:async';
import 'package:clientphase/controllers/rijictcontroller.dart';
import 'package:clientphase/noconn.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:clientphase/controllers/completebooking_controller.dart';

class RijictBookingScreen extends StatefulWidget {
  @override
  _RijictBookingScreenState createState() => _RijictBookingScreenState();
}

class _RijictBookingScreenState extends State<RijictBookingScreen> {
  final RijictBookingController _completeBookingController =
      Get.put(RijictBookingController());
